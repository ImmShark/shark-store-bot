...
module.exports = {
  ...
  async execute(interaction) {
    const embed = new EmbedBuilder()
      ...
      .addFields(
        { name: "<:3339shinystar2:1512142205094068367> Ngân Hàng:", value: "```MB BANK```", inline: true },
        { name: "<:1661shinystar6:1512141829758386226> Số Tài Khoản:", value: "```0328206839```", inline: true },
        { name: "<:3629shinystar4:1512142399932076223> Chủ Tài Khoản:", value: "```LE HOANG VU```", inline: true },
        { name: "<:8819shinystar3:1512142936287088791> Nội Dung:", value: "```SHARKSTORE```", inline: true }
      )
      .setFooter({
